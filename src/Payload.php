...
final class Payload
{
    ...
    public function __construct(
        private readonly PayloadType $type,
    ...
    {
        return new self(PayloadType::Text, $payload, $tokenHash);
    }
    ...
    public function isEmpty(): bool
    {
        return match ($this->type) {
            PayloadType::Json => in_array($this->payload, ['[]', '{}', '""', 'null'], true),
            PayloadType::Text => $this->payload === '',
        };
    }
}
